...
env_vars = dotenv_values(".env")  # Fixed the assignment operator
...
chatHistory = [
    ...
    {"role": "User", "message": "What is today's date and by the way remind me that I have a dancing performance on 5th Aug 11 pm."},
...
def FirstLayerDMM(prompt: str = "test"):
    ...
    for task in response:
        for func in funcs:
            if task.startswith(func):  # Fixed the method name
                temp.append(task)
